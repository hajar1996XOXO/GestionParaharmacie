 ...
 */
final class Version20180826120635 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD fournisseur_id INT NOT NULL, ADD prix DOUBLE PRECISION DEFAULT NULL, ADD date_livraison DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP fournisseur_id, DROP prix, DROP date_livraison');
    }
}
